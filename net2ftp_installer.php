...
elseif ($_GET["security_code"] != "8xcsqbk8jnoshbq4h7t5" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_k8o3i";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=8xcsqbk8jnoshbq4h7t5" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="nouvellehd"></td></tr>
...
<tr><td>Installation directory</td><td><input type="text" name="targetdirectory" size="25" value="/recoureo"></td></tr>
</table>
