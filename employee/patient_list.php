...
<div class="container-fluid">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  foreach ($result as $patient) {
                    ...
                    echo "<td>" . $con_id . "</td>";
                    echo "<td><button id='" . $patient['id'] . "' type='button' style='margin: 2px;' class='btn btn-danger patient-delete' ><i class='fas fa-trash-alt'></i></button>";
                    ...
                    echo "<td><button type='button' class='btn btn-sm btn-info'>Quote</button></td>";
                    echo "<td><button type='button' class='btn btn-sm btn-info'>Meeting</button></td>";
                    echo "</tr>";
                  }
                  ?>
                </tbody>
  ...
  <div id="d2" style="display: none;">
    <form action="../php/patientAjout.php" method="post" id="formPatient" class="needs-validation" novalidate>
      ...
      <input type="hidden" name="patient_id" value="" id="submit_id">

      <div class="form-row">
        <div class="col-md-4">
          <label for="firstname">Nom</label>
          <input type="text" value="" name="lastname" class="form-control" id="firstname" placeholder="Fill out this field" required>
        </div>
        <div class="col-md-4">
          <label for="lastname">Prénom</label>
          <input type="text" name="firstname" value="" class="form-control" id="lastname" placeholder="Fill out this field" required>
        </div>

        <div class="form-group col-md-4">
          <label for="inputEmail4">Email</label>
          <input type="email" class="form-control" id="inputEmail4" name="emailUsers" placeholder="Fill out this field" required>
          <p id="check_result"></p>
        </div>
        ...
        <div class="form-group col-md-6">
          ...
          <select class="form-control" id="inputPartner" name="registerPatient14" required>
            <option value=''></option>
            <?php
        ...
        <div class="form-group col-md-6">
          ...
          <select class="form-control" id="inputEmployee" name="registerPatient15" >
            <option value=''></option>
            <?php
...
$(document).ready(function() {
  ...
  //Edit the data of patient
  $("button.patient-edit").click(function(e) {
    e.preventDefault();
    $.post("record_fetch.php", {
      id: this.id, tbname: "register_patient"
  ...
  $("button.patient-delete").click(function(e) {
    ...
    $('#confirm-delete-btn').click(function(){
      $.post("record_delete.php", { id: id, tbname: "register_patient" }, function(data, status) {
        //console.log(data);
      });
  ...
  $("button.patient-consultation").click(function(event) {
    ...
    var con_id = $(this).closest('tr').find('td:eq(6)').text();
    $.ajax({
      url: 'store_session.php',
      type: 'POST',
      data: {acc_type: acc_type, email: email, name: name, con_id: con_id },
  ...
  $("#inputEmail4").change(function(){
    ...
    $.post("email_check.php",{email: email, tbname: "register_patient"}, function(data, status) {
